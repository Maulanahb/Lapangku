// lib/features/owner/presentation/pages/manage_fields_page.dart
...
class _ManageFieldsPageState extends ConsumerState<ManageFieldsPage> {
  ...
  final Color _accentGreen = const Color(0xFFD1FAE5);
                ...
                child: Column(
                  children: [
                    ...
                    _buildFieldCard(
                      ...
                      imageUrl:
                          'https://images.unsplash.com/photo-1544919933-1ca1479f7560?q=80&w=1000&auto=format&fit=crop',
                    ),
                  ...
                  children: tags.map((tag) {
                    ...
                    return Container(
                      ...
                      child: Text(
                        tag,
                        style: TextStyle(
                          color: isType ? const Color(0xFF1E40AF) : _textGrey,
                          fontSize: 12,
                          fontWeight: FontWeight.w800,
                        ),
                      ),
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Text(
                          ...
                          style: TextStyle(
                            color:
                                isActive ? const Color(0xFF059669) : _textGrey,
                            fontSize: 13,
                            fontWeight: FontWeight.w600,
                          ),
                        ),
