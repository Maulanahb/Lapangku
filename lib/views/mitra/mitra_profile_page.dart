...
class MitraProfilePage extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final bookingsAsync = ref.watch(mitraBookingsProvider(uid));
    ...
    return Scaffold(
      ...
      body: profileAsync.when(
        ...
        data: (profile) {
          ...
          int activeFieldsCount = profile.totalFields;
          if (fieldAsync is AsyncData) {
            final fields = fieldAsync.value!;
                ...
                _buildMenuSection(
                  ...
                  items: [
                    _buildMenuItem(
                      ...
                      title: "Lapangan Saya",
                      subtitle: "$activeFieldsCount lapangan aktif",
                ...
                _buildMenuSection(
                  ...
                  items: [
                    _buildMenuItem(
                      ...
                      title: "Pendapatan",
                      subtitle: "Pantau pemasukan & pencairan",
                      onTap: () => Navigator.push(
                        context,
                        MaterialPageRoute(
                    ...
                    _buildMenuItem(
                      ...
                      subtitle: "Ringkasan performa booking",
                      onTap: () => Navigator.push(
                        context,
                        MaterialPageRoute(
  ...
  // 👇 PENINGKATAN UI/UX: Avatar yang lebih modern
  Widget _buildHeroSection(
      BuildContext context, WidgetRef ref, MitraProfileModel profile) {
    return Container(
              ...
              children: [
                ...
                Positioned(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      color: AppColors.primaryLight, // Biru/hijau muda
                      shape: BoxShape.circle,
          ...
          if (profile.isVerified) ...[
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(
                    color: Colors.white
                        .withOpacity(0.3)), // Tambahan border transparan
              ),
              child: const Row(
  ...
  // 👇 PENINGKATAN UI/UX: Shadow dan margin pada menu
      ...
      children: [
        Padding(
          ...
          child: Text(
            title,
            style: const TextStyle(
              fontSize: 13, // Sedikit dikecilkan agar terlihat elegan
              fontWeight: FontWeight.w800,
              letterSpacing: 0.5,
              color:
                  AppColors.textSecondary, // Warna sekunder agar tidak tabrakan
            ),
          ),
        ),
        Container(
          ...
          decoration: BoxDecoration(
            ...
            boxShadow: [
              BoxShadow(
                color: Colors.black
                    .withOpacity(0.04), // Shadow lebih halus (modern)
                blurRadius: 12,
  ...
  Widget _buildMenuItem(
    ...
    return ListTile(
      ...
      contentPadding: const EdgeInsets.symmetric(
          horizontal: 16, vertical: 4), // UX: Area klik lebih besar
      leading: Container(
  ...
  Future<void> _pickImage(BuildContext context, WidgetRef ref,
      ImageSource source, MitraProfileModel profile) async {
  ...
  Future<void> _deletePhoto(
      BuildContext context, WidgetRef ref, MitraProfileModel profile) async {
