...
import 'package:lapangku/features/owner/schedule/providers/owner_schedule_provider.dart';
import 'package:lapangku/utils/snackbar_helper.dart';

class OwnerSchedulePage extends ConsumerWidget {
  const OwnerSchedulePage({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final fieldsAsync = ref.watch(ownerFieldProvider).fields;
    final scheduleState = ref.watch(ownerScheduleProvider);
              ...
              Container(
                ...
                child: DropdownButtonFormField<String>(
                  ...
                  onChanged: (id) {
                    if (id != null) {
                      ref
                          .read(ownerScheduleProvider.notifier)
                          .selectField(id);
                    }
                  },
                ),
...
class _ScheduleList extends ConsumerWidget {
  final List<OwnerScheduleModel> schedules;
