...
import 'package:lapangku/features/owner/revenue/providers/owner_revenue_provider.dart';

class OwnerRevenuePage extends ConsumerStatefulWidget {
  const OwnerRevenuePage({super.key});

  @override
  ConsumerState<OwnerRevenuePage> createState() => _OwnerRevenuePageState();
}

class _OwnerRevenuePageState extends ConsumerState<OwnerRevenuePage> {
  ...
  Widget build(BuildContext context) {
    final revenueAsync = ref.watch(ownerRevenueProvider);
            ...
            child: revenueAsync.when(
              ...
              data: (revenue) {
                return RefreshIndicator(
                  ...
                  onRefresh: () async {
                    await ref.read(ownerRevenueProvider.notifier).loadRevenue();
                  },
