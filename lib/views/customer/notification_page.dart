          ...
          IconButton(
            ...
            onPressed: () async {
              ...
              if (user != null) {
                ...
                await ref.read(notificationControllerProvider).markAllAsRead(user.uid);
      ...
      body: notificationsAsync.when(
        ...
        data: (notifications) {
          ...
          return RefreshIndicator(
            onRefresh: () async {
              // Refresh is handled automatically by StreamProvider, but we can invalidate to force reload
      ...
      child: GestureDetector(
        onTap: () async {
          ...
          if (notification.type == 'booking') {
            // Adjust the route based on the app's actual navigation paths
