...
import 'package:lapangku/standards/constants/app_colors.dart'; // Import AppColors agar konsisten
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: Container(
        ...
        // Menggunakan SafeArea agar navbar memiliki ukuran/padding yang pas di device modern
        child: SafeArea(
          child: SizedBox(
            height:
                64, // Tinggi ideal untuk navbar agar presisi sama dengan mitra
            child: BottomNavigationBar(
              ...
              elevation: 0,
              iconSize: 24, // Menyeragamkan ukuran ikon
              selectedItemColor:
                  AppColors.primary, // Menggunakan variabel AppColors
